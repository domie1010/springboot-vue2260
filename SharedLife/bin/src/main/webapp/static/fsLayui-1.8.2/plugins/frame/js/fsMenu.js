...
layui.define(['element',"fsConfig","fsCommon"], function(exports){
	...
	var menuConfig = {
			...
			data : [
				...
				{"menuId":"timelineid","menuName":"轴管理","menuIcon":"fa-list","menuHref":"/admin/timeline/index.html","parentMenuId":"11"},
				{"menuId":"musicid","menuName":"yy管理","menuIcon":"fa-list","menuHref":"/admin/music/index.html","parentMenuId":"11"},
		 ] //本地数据
	};
